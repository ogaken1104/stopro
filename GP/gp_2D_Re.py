...
class GPmodel2DStokesRe(GPmodel2D):
    """
    2D stokesian process for enabling Re
    """
    ...
    def setup_gov_gov_kernel(self, θ):
        ...
        def Kfxfx(r, rp):
            return self.d0d0(r, rp, θpp) + self.LL(r, rp, θuxux) / self.Re**2

        def Kfxfy(r, rp):
            return self.d0d1(r, rp, θpp)

        def Kfyfy(r, rp):
            return self.d1d1(r, rp, θpp) + self.LL(r, rp, θuyuy) / self.Re**2

        def Kfxdiv(r, rp):
            return -self.Ld0(r, rp, θuxux) / self.Re

        def Kfydiv(r, rp):
            return -self.Ld1(r, rp, θuyuy) / self.Re
    ...
    def setup_nondifop_difop_kernel(self, θ):
        ...
        def Kuxfx(r, rp):
            return -self.L1(r, rp, θuxux) / self.Re
        ...
        def Kuyfy(r, rp):
            return -self.L1(r, rp, θuyuy) / self.Re
