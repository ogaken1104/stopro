...
class GPmodel2DStokes4Kernels(GPmodel2D):
    """
    ...
    def setup_no_diffop_kernel(self, θ):
        ...
        """
        θuxux, θuyuy, θpp, θuxuy = self.split_hyperparam(theta=θ)
    ...
    def setup_gov_gov_kernel(self, θ):
        ...
        def Kfxfy(r, rp):
            return self.d0d1(r, rp, θpp) + self.LL(r, rp, θuxuy)

        def Kfyfy(r, rp):
            return self.d1d1(r, rp, θpp) + self.LL(r, rp, θuyuy)

        def Kfxdiv(r, rp):
            return -self.Ld0(r, rp, θuxux) - self.Ld1(r, rp, θuxuy)

        def Kfydiv(r, rp):
            return -self.Ld0_rev(r, rp, θuxuy) - self.Ld1(r, rp, θuyuy)
    ...
    def setup_nondifop_difop_kernel(self, θ):
        ...
        def Kuyfx(r, rp):
            return -self.L1_rev(r, rp, θuxuy)

        def Kpfx(r, rp):
            return self.d10(r, rp, θpp)

        def Kuxfy(r, rp):
            return -self.L1(r, rp, θuxuy)
