...
class GPufdiv(GPSinusoidalWithoutPIndependent):
...
class GPufdivNoisyu(GPSinusoidalWithoutPIndependent):
    def trainingKs(self, θ):
        Kuxux, Kuxuy, Kuyuy, Kuxp, Kuyp, Kpp = self.setup_no_diffop_kernel(θ)
        (
            Kuxfx,
        ...
        Ks = [
            [Kuxux, Kuxuy, Kuxux, Kuxuy, Kuxfx, Kuxfy, Kuxdiv],
            [Kuyuy, Kuxuy, Kuyuy, Kuyfx, Kuyfy, Kuydiv],
            [Kuxux, Kuxuy, Kuxfx, Kuxfy, Kuxdiv],
            [Kuyuy, Kuyfx, Kuyfy, Kuydiv],
            [Kfxfx, Kfxfy, Kfxdiv],
            [Kfyfy, Kfydiv],
    ...
    def mixedK_all(self, θ, test_pts, train_pts):
        ...
        if self.infer_governing_eqs:
            ...
            Ks = [
                [Kuxux, Kuxuy, Kuxux, Kuxuy, Kuxfx, Kuxfy, Kuxdiv],
                [Kuxuy, Kuyuy, Kuxuy, Kuyuy, Kuyfx, Kuyfy, Kuydiv],
            ]
        else:
            Ks = [
                [Kuxux, Kuxuy, Kuxux, Kuxuy, Kuxfx, Kuxfy, Kuxdiv],
