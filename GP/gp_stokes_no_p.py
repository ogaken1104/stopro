...
class GPUseNoP(GPmodel):
    ...
    def setup_training_and_predicting_functions(self, Kernel, approx_non_pd=False):
        ...
        # define operators
        def _L0(r, rp, θ):
            return jnp.sum(jnp.diag(jax.hessian(Kernel, 0)(r, rp, θ)))

        def _L1(r, rp, θ):
            return jnp.sum(jnp.diag(jax.hessian(Kernel, 1)(r, rp, θ)))

        def _d0d0(r, rp, θ):
            return jax.hessian(Kernel, [0, 1])(r, rp, θ)[0][1][0, 0]

        def _d0d1(r, rp, θ):
            return jax.hessian(Kernel, [0, 1])(r, rp, θ)[0][1][0, 1]

        def _d1d0(r, rp, θ):
            return jax.hessian(Kernel, [0, 1])(r, rp, θ)[0][1][1, 0]

        def _d1d1(r, rp, θ):
            return jax.hessian(Kernel, [0, 1])(r, rp, θ)[0][1][1, 1]
        ...
        def _d10(r, rp, θ):
            return grad(Kernel, 1)(r, rp, θ)[0]

        def _d11(r, rp, θ):
            return grad(Kernel, 1)(r, rp, θ)[1]

        def _d00(r, rp, θ):
            return grad(Kernel, 0)(r, rp, θ)[0]

        def _d01(r, rp, θ):
            return grad(Kernel, 0)(r, rp, θ)[1]
        ...
        def _L0_rev(r, rp, θ):
            return jnp.sum(jnp.diag(jax.hessian(Kernel_rev, 0)(r, rp, θ)))

        def _L1_rev(r, rp, θ):
            return jnp.sum(jnp.diag(jax.hessian(Kernel_rev, 1)(r, rp, θ)))

        def _d0d0_rev(r, rp, θ):
            return jax.hessian(Kernel_rev, [0, 1])(r, rp, θ)[0][1][0, 0]

        def _d0d1_rev(r, rp, θ):
            return jax.hessian(Kernel_rev, [0, 1])(r, rp, θ)[0][1][0, 1]

        def _d1d0_rev(r, rp, θ):
            return jax.hessian(Kernel_rev, [0, 1])(r, rp, θ)[0][1][1, 0]

        def _d1d1_rev(r, rp, θ):
            return jax.hessian(Kernel_rev, [0, 1])(r, rp, θ)[0][1][1, 1]
        ...
        def _dij_rev(i, j, r, rp, θ):
            return grad(Kernel_rev, i)(r, rp, θ)[j]
        ...
        def _d10_rev(r, rp, θ):
            return grad(Kernel_rev, 1)(r, rp, θ)[0]

        def _d11_rev(r, rp, θ):
            return grad(Kernel_rev, 1)(r, rp, θ)[1]
        ...
        def _d00_rev(r, rp, θ):
            return grad(Kernel_rev, 0)(r, rp, θ)[0]

        def _d01_rev(r, rp, θ):
            return grad(Kernel_rev, 0)(r, rp, θ)[1]
        ...
        def trainingK_all(θ, train_pts):
            ...
            def Kuxfx(r, rp):
                return d10(r, rp, θuxp) - L1(r, rp, θuxux)

            def Kuyfx(r, rp):
                return d10(r, rp, θuyp) - L1_rev(r, rp, θuxuy)

            def Kpfx(r, rp):
                return d10(r, rp, θpp) - L1_rev(r, rp, θuxp)
            ...
            def Kuxfy(r, rp):
                return d11(r, rp, θuxp) - L1(r, rp, θuxuy)

            def Kuyfy(r, rp):
                return d11(r, rp, θuyp) - L1(r, rp, θuyuy)

            def Kpfy(r, rp):
                return d11(r, rp, θpp) - L1_rev(r, rp, θuyp)
            ...
            def Kuxdiv(r, rp):
                return d10(r, rp, θuxux) + d11(r, rp, θuxuy)

            def Kuydiv(r, rp):
                return d10_rev(r, rp, θuxuy) + d11(r, rp, θuyuy)

            def Kpdiv(r, rp):
                return d10_rev(r, rp, θuxp) + d11_rev(r, rp, θuyp)
            ...
            if self.use_difp:
                ...
                def Kfxp(r, rp):
                    return d00(r, rp, θpp) - L0(r, rp, θuxp)

                def Kfyp(r, rp):
                    return d01(r, rp, θpp) - L0(r, rp, θuyp)

                def Kdivp(r, rp):
                    return d00(r, rp, θuxp) + d01(r, rp, θuyp)
        ...
        def mixedK_all(θ, test_pts, train_pts):
            ...
            def Kuyux(r, rp):
                return K_rev(r, rp, θuxuy)

            def Kpux(r, rp):
                return K_rev(r, rp, θuxp)

            def Kpuy(r, rp):
                return K_rev(r, rp, θuyp)
            ...
            if self.infer_governing_eqs:
                ...
                def Kfxux(r, rp):
                    return d00_rev(r, rp, θuxp) - L0(r, rp, θuxux)

                def Kfxuy(r, rp):
                    return d00_rev(r, rp, θuyp) - L0(r, rp, θuxuy)

                def Kfyux(r, rp):
                    return d01_rev(r, rp, θuxp) - L0_rev(r, rp, θuxuy)

                def Kfyuy(r, rp):
                    return d01_rev(r, rp, θuyp) - L0(r, rp, θuyuy)
                ...
                def Kdivux(r, rp):
                    return d00(r, rp, θuxux) + d01_rev(r, rp, θuxuy)

                def Kdivuy(r, rp):
                    return d00(r, rp, θuxuy) + d01(r, rp, θuyuy)
