...
def analyze_result(f_test, f_infer, std, theta, loss, norm_of_grads_list, lbls_kernel_arg, vnames_analysis):
    ...
    # hdf5ファイルに保存
    vals_list = [absolute_error, relative_error, max_abs_error,
                 max_rel_error, mean_abs_error, mean_rel_error]
