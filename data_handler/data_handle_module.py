...
class HdfOperator:
    """
    Class for saving and loading data as hdf files.

    Attributes:
        self.xxx_path: path of xxx data
    """

    def __init__(self, simulation_path=".."):
        """
        Args:
            simulation_path: path for the directory which contains data_input and data_output directory.
        """
    ...
    def save_test_data(self, lbls_test, vnames_test, vals_list):
        self.save_data(self.test_path, lbls_test, vnames_test, vals_list)

    def save_train_data(self, lbls_train, vnames_train, vals_list):
        self.save_data(self.train_path, lbls_train, vnames_train, vals_list)

    def save_infer_data(self, lbls_infer, vnames_infer, vals_list):
        self.save_data(self.infer_path, lbls_infer, vnames_infer, vals_list)
