...
class DataPreparer:
    def __init__(self, project_name, simulation_name) -> None:
    ...
    def make_data(self, class_data_generator, plot_training=True, plot_test=False):
        # DataGeneratorのインスタンスを作成
        sample = class_data_generator(**self.params_setting)
