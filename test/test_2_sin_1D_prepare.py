...
def prepare(
    ...
    data_preparer = DataPreparer(
        ...
        project_name,
        simulation_name,
        class_data_generator=Sin1DNaive,
    )
    ...
    data_preparer.params_generate_training["y_num"] = y_num
    data_preparer.params_generate_training["sigma2_noise"] = 1.0e-02
...
def test_sin_1D_prepare():
    ...
    prepare(project_name, f"sin_1D_naive_noise", use_existing_params=False, y_num=32)
